            ...
            <Layout>
              {
                <Container textAlign='justified'>
                  <div>
                    <Header as='h1'>Aceito</Header>
                    <Message textAlign='' >foo bar</Message>
                  </div>
                </Container>
              }
            </Layout>
            ...
            <Layout>
              {
                <Container textAlign='justified'>
                  <div>
                    <Header as='h1'>Não Aceito</Header>
                    <Message textAlign='' >foo bar baz</Message>
                  </div>
                </Container>
              }
            </Layout>
